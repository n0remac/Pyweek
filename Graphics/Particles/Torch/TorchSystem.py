...
class TorchSystem(ParticleSystem):
    ...
    def build_buffer(self):
        ...
        buffer_description = arcade.gl.BufferDescription(self._emit_buffer,
                                                        '2f 1f',
                                                        ['in_position', 'in_type'])
    ...
    def do_burst(self):
        self.emit_with_program(self.burst_program, self.burst_count, buffer=self.custom_emission)
        pass
