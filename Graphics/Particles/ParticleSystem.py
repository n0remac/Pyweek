...
class ParticleSystem:
    ...
    def init_system(
        ...
        buffer_description = arcade.gl.BufferDescription(
            self.buffer, buffer_format, buffer_attributes
        )
    ...
    def init_emission(context):
        ...
        buffer_description = arcade.gl.BufferDescription(
            ParticleSystem.___buffer, "1f", ["in_placeholder"]
        )
    ...
    def emit_with_program(self, program, count, vao=None):
        ...
        if count + self.current_emission_index < self.max_particles:
            ...
            self.emit_internal(
                ...
                0,
                count,
                self.particle_byte_length * self.current_emission_index,
            )
